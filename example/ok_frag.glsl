...
//!BEGIN_POST_CHUNK tonemapping_fragment
#if defined( TONE_MAPPING )
	gl_FragColor.rgb = toneMapping( gl_FragColor.rgb );
#endif
//!END_POST_CHUNK
//!BEGIN_POST_CHUNK encodings_fragment
gl_FragColor = linearToOutputTexel( gl_FragColor );
//!END_POST_CHUNK
//!BEGIN_POST_CHUNK fog_fragment
#ifdef USE_FOG
	#ifdef FOG_EXP2
...
#endif
//!END_POST_CHUNK
//!BEGIN_POST_CHUNK premultiplied_alpha_fragment
#ifdef PREMULTIPLIED_ALPHA
	gl_FragColor.rgb *= gl_FragColor.a;
#endif
//!END_POST_CHUNK
//!BEGIN_POST_CHUNK dithering_fragment
#ifdef DITHERING
