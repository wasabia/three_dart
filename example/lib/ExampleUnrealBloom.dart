...
class ExampleUnrealBloom extends StatefulWidget {
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<ExampleUnrealBloom> {
  ...
  initScene() async {
    ...
    var bloomPass = new THREE.UnrealBloomPass( new THREE.Vector2( 502, 502 ), 1.5, 0.4, 0.85 );
    bloomPass.threshold = 0;
    bloomPass.strength = 1.5;
    bloomPass.radius = 0;


    // var bloomPass = new THREE.BloomPass( 1, null, null, 500 );
