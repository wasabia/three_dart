...
class _State extends State<webgl_morphtargets_sphere> {
  ...
  initPage() async {
    ...
    var _texture = await three.TextureLoader(null).loadAsync('assets/textures/sprites/disc.png');

    var pointsMaterial =
        three.PointsMaterial({"size": 10, "sizeAttenuation": false, "map": _texture, "alphaTest": 0.5});
