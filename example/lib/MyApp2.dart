...
class _MyAppState extends State<MyApp2> {
  ...
  initScene() async {
    ...
    var geometry = new THREE.BoxBufferGeometry( width: 5, height: 5, depth: 5 );
    ...
    for ( var i = 0; i < 5000; i ++ ) {
      ...
      mesh.position.x = THREE.Math.random() * 8000 - 4000;
      mesh.position.y = THREE.Math.random() * 8000 - 4000;
      mesh.position.z = THREE.Math.random() * 8000 - 4000;
      mesh.rotation.x = THREE.Math.random() * 2 * THREE.Math.PI;
      mesh.rotation.y = THREE.Math.random() * 2 * THREE.Math.PI;
      mesh.scale.x = mesh.scale.y = mesh.scale.z = THREE.Math.random() * 50 + 100;
