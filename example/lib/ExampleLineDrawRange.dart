...
class ExampleLineDrawRange extends StatefulWidget {
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<ExampleLineDrawRange> {
  ...
  initScene() async {
    ...
    positions = new THREE.Float32Array( segments * 3 );
    colors = new THREE.Float32Array( segments * 3 );
    ...
    particlePositions = new THREE.Float32Array( maxParticleCount * 3 );

    for ( var i = 0; i < maxParticleCount; i ++ ) {

      var x = THREE.Math.random() * r - r / 2;
      var y = THREE.Math.random() * r - r / 2;
      var z = THREE.Math.random() * r - r / 2;
      ...
      particlesData.add( {
        "velocity": new THREE.Vector3( - 1 + THREE.Math.random() * 2, - 1 + THREE.Math.random() * 2, - 1 + THREE.Math.random() * 2 ),
        "numConnections": 0
      } );
    ...
    particles.setAttribute( 'position', new THREE.Float32BufferAttribute( particlePositions, 3, false ).setUsage( THREE.DynamicDrawUsage ) );
    ...
    geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( positions, 3, false ).setUsage( THREE.DynamicDrawUsage ) );
    geometry.setAttribute( 'color', new THREE.Float32BufferAttribute( colors, 3, false ).setUsage( THREE.DynamicDrawUsage ) );
    ...
    // // geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( THREE.Float32Array.from(positions), 3, false ).setUsage( THREE.DynamicDrawUsage ) );
    // // geometry.setAttribute( 'color', new THREE.Float32BufferAttribute( THREE.Float32Array.from(colors), 3, false ).setUsage( THREE.DynamicDrawUsage ) );
    // // geometry.computeBoundingSphere();
    // // geometry.setDrawRange( 0, 0 );
    ...
    // linesMesh = new THREE.Line2( geometry, matLine );
