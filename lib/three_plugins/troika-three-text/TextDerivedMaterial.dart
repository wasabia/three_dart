...
createTextDerivedMaterial(baseMaterial) {
  var textMaterial = createDerivedMaterial(baseMaterial, {
    ...
    "uniforms": {
      ...
      "uTroikaOutlineOpacity": {"value": 0.0},
      "uTroikaFillOpacity": {"value": 1.0},
      "uTroikaPositionOffset": {"value": Vector2(null, null)},
      "uTroikaCurveRadius": {"value": 0.0},
      "uTroikaBlurRadius": {"value": 0.0},
      "uTroikaStrokeWidth": {"value": 0.0},
      "uTroikaStrokeColor": {"value": Color(0,0,0)},
      "uTroikaStrokeOpacity": {"value": 1.0},
      "uTroikaOrient": {"value": Matrix3()},
    ...
    "customRewriter": (shaderInfo) {
      ...
      if (uDiffuseRE.hasMatch(fragmentShader)) {
        ...
        fragmentShader = fragmentShader
          .replaceAll(uDiffuseRE, 'varying vec3 vTroikaGlyphColor')
          .replaceAll(_bdiffuse, 'vTroikaGlyphColor');
        // Make sure the vertex shader declares the uniform so we can grab it as a fallback
        if (!uDiffuseRE.hasMatch(vertexShader)) {

          RegExpMatch? match = voidMainRegExp.firstMatch(vertexShader);

          if(match != null) {
            String _replace = "uniform vec3 diffuse;\n${match.group(0)}\nvTroikaGlyphColor = uTroikaUseGlyphColors ? aTroikaGlyphColor / 255.0 : diffuse;\n";
