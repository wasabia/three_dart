...
class LineSegments2 extends Mesh {
  ...
  computeLineDistances() { // for backwards-compatability, but could be a method of LineSegmentsGeometry...
    ...
    var lineDistances = new Float32Array( (2 * instanceStart.data.count).toInt() );
    ...
    geometry.setAttribute( 'instanceDistanceStart', new InterleavedBufferAttribute( instanceDistanceBuffer, 1, 0, false ) ); // d0
    geometry.setAttribute( 'instanceDistanceEnd', new InterleavedBufferAttribute( instanceDistanceBuffer, 1, 1, false ) ); // d1
