...
class CylinderBufferGeometry extends BufferGeometry {
  ...
  String type = "CylinderBufferGeometry";

	CylinderBufferGeometry( {radiusTop = 1, radiusBottom = 1, height = 1, radialSegments = 8, heightSegments = 1, bool openEnded = false, thetaStart = 0, thetaLength = Math.PI * 2} ) : super() {
