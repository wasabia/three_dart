...
class ExtrudeBufferGeometry extends BufferGeometry {
  ...
  String type = "ExtrudeBufferGeometry";

	ExtrudeBufferGeometry(List<Shape> shapes, Map<String, dynamic> options ) : super() {
  ...
  ExtrudeBufferGeometry.fromJSON(Map<String, dynamic> json, Map<String, dynamic> rootJSON) : super.fromJSON(json, rootJSON) {
