...
class Ray {
  ...
  var _segCenter = /*@__PURE__*/ new Vector3.init();
  var _segDir = /*@__PURE__*/ new Vector3.init();
  var _diff = /*@__PURE__*/ new Vector3.init();

  var _edge1 = /*@__PURE__*/ new Vector3.init();
  var _edge2 = /*@__PURE__*/ new Vector3.init();
  var _normal = /*@__PURE__*/ new Vector3.init();

  late Vector3 origin;
  late Vector3 direction;

  Ray(origin, direction) {
    this.origin = (origin != null) ? origin : new Vector3.init();
  ...
  clone() {
    return new Ray(null, null).copy(this);
  }
  ...
  distanceSqToPoint(point) {
    var directionDistance =
        _vector.subVectors(point, this.origin).dot(this.direction);
  ...
  distanceSqToSegment(v0, v1, optionalPointOnRay, optionalPointOnSegment) {
    ...
    num a01 = -this.direction.dot(_segDir);
